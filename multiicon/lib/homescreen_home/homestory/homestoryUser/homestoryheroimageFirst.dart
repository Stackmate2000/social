...
class HomeStoryHeroImageFirst extends StatefulWidget {
  @override
  _HomeStoryHeroImageFirstState createState() =>
      _HomeStoryHeroImageFirstState();
}

class _HomeStoryHeroImageFirstState extends State<HomeStoryHeroImageFirst> {
