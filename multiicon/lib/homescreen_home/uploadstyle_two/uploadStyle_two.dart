...
class UploadStyleTwo extends StatefulWidget {
  const UploadStyleTwo({Key key}) : super(key: key);

  @override
  _UploadStyleTwoState createState() => _UploadStyleTwoState();
}

class _UploadStyleTwoState extends State<UploadStyleTwo> {
  int counter = 0;
  bool isliked = false;
