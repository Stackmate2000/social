...
class HomeScreenHomeCaptionPostTwo extends StatefulWidget {
  @override
  _HomeScreenHomeCaptionPostTwoState createState() =>
      _HomeScreenHomeCaptionPostTwoState();
}

class _HomeScreenHomeCaptionPostTwoState
    extends State<HomeScreenHomeCaptionPostTwo> {
  @override
